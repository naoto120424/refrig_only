...
def main():
    ...
    parser.add_argument("--branch_layers", type=int, default=2, help="(DeepOx) num of Branch Net Layers")
    parser.add_argument("--width", type=int, default=256, help="(DeepOx) Trunk Net and Branch Net dimension")
