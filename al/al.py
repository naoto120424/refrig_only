...
def main(data, csv_files, args, cfg, train_index_list, val_index_list, test_index_list):
...
if __name__ == "__main__":
    ...
    for rate in rate_list:
        if rate == 1.0:
            ...
            train_index_list_tmp += random.sample(model_train_index_list, int(len(train_index_list) * 0.1))
            model_train_index_list = list(set(model_train_index_list).difference(set(train_index_list_tmp)))
        ...
        for model in model_list:
            ...
            if model == "dol":
                args.width = 64
            ade_list_tmp = main(data, csv_files, args, cfg, train_index_list_tmp, val_index_list, test_index_list)
